...
import CardOyun from '../components/CardOyun';
...
componentDidMount(){
    try {
      ...
      .then(querySnapshot => {
        this.setState({
          userName:querySnapshot.data().ad,
          lastScore:querySnapshot.data().esleskor
        })
      });
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
				  <Text style={styles.header_text}>Esle Kazan</Text>
		  	</View>
        ...
        <View style={styles.maxScView}>
            <Text style={styles.maxSc}>{this.state.userName} En yüksek skor: {this.state.lastScore}</Text>
          </View>
        ...
        <View style={styles.xxx}>
          ...
          <Text style={styles.score}>Skor: {this.state.score}</Text>
        </View>
        ...
        <TouchableOpacity style={styles.RankingBtn} onPress={() => {this.reset(); this.props.navigation.goBack();}}>
          <Text style={{color:'white',fontWeight:'bold',}} >
            Geri Gel
          </Text>
        </TouchableOpacity>
